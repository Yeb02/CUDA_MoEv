...
private:
	...
	std::unordered_map<int, Node_G*> complexIDmap;
	...
	std::unique_ptr<Node_G> topNodeG;

	std::vector<std::unique_ptr<Node_G>> complexGenome;
	...
	//			 - created alongside Node_P creation; 
	//           - freed alongside Node_P deletion.
